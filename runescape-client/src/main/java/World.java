	...
	static int method1899(int var0, Script var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.MES) {
			...
			if (var0 == ScriptOpcodes.RESUME_COUNTDIALOG) {
				...
				PacketBufferNode var13 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3182, Client.packetWriter.isaacCipher);
				...
				if (var0 == ScriptOpcodes.RESUME_NAMEDIALOG) {
					var7 = Interpreter.Interpreter_stringStack[--class127.Interpreter_stringStackSize];
					var11 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3221, Client.packetWriter.isaacCipher);
					...
					var7 = Interpreter.Interpreter_stringStack[--class127.Interpreter_stringStackSize];
					var11 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3160, Client.packetWriter.isaacCipher);
					var11.packetBuffer.writeByte(var7.length() + 1);
					var11.packetBuffer.writeStringCp1252NullTerminated(var7);
					Client.packetWriter.addNode(var11);
					return 1;
					...
					if (var0 == ScriptOpcodes.OPPLAYER) {
						...
						var3 = Interpreter.Interpreter_intStack[--DbTableType.Interpreter_intStackSize];
						var11 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3184, Client.packetWriter.isaacCipher);
