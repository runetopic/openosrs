...
public class class60 {
	...
	static final void menuAction(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7, int var8) {
		...
		if (var2 == 1002) {
			...
			Client.mouseCrossColor = 2;
			Client.mouseCrossState = 0;
			var16 = class503.getPacketBufferNode(ClientPacket.field3166, Client.packetWriter.isaacCipher);
		...
		Widget var19;
		if (var2 == 29) {
			var16 = class503.getPacketBufferNode(ClientPacket.field3191, Client.packetWriter.isaacCipher);
		...
		if (var2 == 25) {
			...
			if (var2 == 46) {
				...
				if (var14 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var15 = class503.getPacketBufferNode(ClientPacket.field3135, Client.packetWriter.isaacCipher);
					var15.packetBuffer.writeByte(Client.field750.method4151(82) ? 1 : 0);
					var15.packetBuffer.writeShort(var3);
					Client.packetWriter.addNode(var15);
				}
			...
			if (var2 == 24) {
				...
				if (var17 != null) {
					...
					if (var13) {
						var11 = class503.getPacketBufferNode(ClientPacket.field3191, Client.packetWriter.isaacCipher);
