...
class SecureRandomSSLSocket extends SSLSocket {
	...
	static int method131(int var0, Script var1, boolean var2) {
		if (var0 == ScriptOpcodes.CHAT_GETFILTER_PUBLIC) {
			...
			PacketBufferNode var13 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3143, Client.packetWriter.isaacCipher);
			...
			if (var0 == ScriptOpcodes.CHAT_SENDABUSEREPORT) {
				...
				var6 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3204, Client.packetWriter.isaacCipher);
				...
				if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYTYPEANDLINE) {
					...
					if (var0 == ScriptOpcodes.CHAT_GETHISTORY_BYUID) {
						...
						if (var0 == ScriptOpcodes.CHAT_SENDPUBLIC) {
							...
							var12 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3202, Client.packetWriter.isaacCipher);
