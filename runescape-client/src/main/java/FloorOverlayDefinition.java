		...
		if (var5 != null) {
			...
			if (var8) {
				if (GraphicsObject.method2128(class361.getWidgetFlags(var5), var0 - 1)) {
					...
					if (var0 == 1) {
						var7 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3201, Client.packetWriter.isaacCipher);
					...
					if (var0 == 2) {
						var7 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3150, Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 3) {
						var7 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3207, Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 4) {
						var7 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3156, Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 5) {
						var7 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3145, Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 6) {
						var7 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3125, Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 7) {
						var7 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3140, Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 8) {
						var7 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3152, Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 9) {
						var7 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3159, Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
					...
					if (var0 == 10) {
						var7 = SecureUrlRequester.getPacketBufferNode(ClientPacket.field3130, Client.packetWriter.isaacCipher);
						var7.packetBuffer.writeInt(var1);
						var7.packetBuffer.writeShort(var2);
						var7.packetBuffer.writeShort(var3);
						Client.packetWriter.addNode(var7);
