...
public final class Client extends GameEngine implements Usernamed, OAuthApi, class322 {
	...
	protected final void setUp() {
		...
		class9.setWindowedMode(WorldMapIcon_1.clientPreferences.method2564());
	...
	void method1268(String var1) throws IOException {
		...
		try {
			...
			if (loginState == 5) {
				...
				if (gameState == 40) {
					...
					if (gameState == 50) {
						var28.writeByte(class124.field1472.rsOrdinal());
						var28.writeInt(class160.field1748);
					} else {
						var28.writeByte(field525.rsOrdinal());
						switch(field525.field1468) {
						case 0:
						case 1:
							var28.writeMedium(class53.field350);
							++var28.offset;
							break;
						case 2:
							var28.offset += 4;
							break;
						case 3:
							var28.writeInt(WorldMapIcon_1.clientPreferences.method2567(Login.Login_username));
						}
					}
				...
				var32.packetBuffer.writeIntME(PcmPlayer.field281.hash);
				var32.packetBuffer.method9316(SoundSystem.field298.hash);
				var32.packetBuffer.writeIntLE(class145.field1643.hash);
				var32.packetBuffer.method9316(class7.field25.hash);
				var32.packetBuffer.writeIntLE(class514.archive6.hash);
				var32.packetBuffer.writeIntLE(StructComposition.field2041.hash);
				var32.packetBuffer.method9316(class313.archive4.hash);
				var32.packetBuffer.writeIntME(UserComparator7.field1441.hash);
				var32.packetBuffer.writeIntLE(WorldMapDecorationType.archive10.hash);
				var32.packetBuffer.writeIntME(SpotAnimationDefinition.field2007.hash);
				var32.packetBuffer.method9316(Canvas.field114.hash);
				var32.packetBuffer.writeIntME(VarbitComposition.archive13.hash);
				var32.packetBuffer.writeInt(WorldMapData_0.field2426.hash);
				var32.packetBuffer.method9316(0);
				...
				var32.packetBuffer.writeIntLE(Language.field4412.hash);
				var32.packetBuffer.writeInt(WorldMapSection0.archive9.hash);
				var32.packetBuffer.writeIntLE(class19.field92.hash);
				var32.packetBuffer.writeIntME(class344.archive2.hash);
				var32.packetBuffer.writeIntME(BuddyRankComparator.field1460.hash);
			...
			if (loginState == 6 && var1.available() > 0) {
				...
				if (var12 == 21 && gameState == 20) {
					class19.method295(12);
				} else if (var12 == 2) {
					class19.method295(14);
				} else if (var12 == 15 && gameState == 40) {
					packetWriter.serverPacketLength = -1;
					class19.method295(19);
				} else if (var12 == 64) {
					class19.method295(10);
				} else if (var12 == 23 && field614 < 1) {
					++field614;
					class19.method295(0);
				} else if (var12 == 29) {
					class19.method295(17);
				} else {
					if (var12 != 69) {
						class149.getLoginError(var12);
						return;
			...
			if (loginState == 13) {
				...
				if (loginState == 15 && var1.available() >= SoundCache.field303) {
					...
					if (var38) {
						...
						WorldMapIcon_1.clientPreferences.method2565(Login.Login_username, var13);
					}

					if (Login_isUsernameRemembered) {
						WorldMapIcon_1.clientPreferences.method2586(Login.Login_username);
					} else {
		...
		if (hadNetworkError) {
			...
			if (gameState == 30) {
				...
				while (class216.method4239()) {
					var14 = class113.getPacketBufferNode(ClientPacket.field3192, packetWriter.isaacCipher);
				...
				if (timer.field4596) {
					var14 = class113.getPacketBufferNode(ClientPacket.field3169, packetWriter.isaacCipher);
					var14.packetBuffer.writeByte(0);
					var2 = var14.packetBuffer.offset;
				...
				if (MouseHandler.MouseHandler_lastButton == 1 || !class19.mouseCam && MouseHandler.MouseHandler_lastButton == 4 || MouseHandler.MouseHandler_lastButton == 2) {
					...
					var5 = (int)var16;
					PacketBufferNode var18 = class113.getPacketBufferNode(ClientPacket.field3164, packetWriter.isaacCipher);
				...
				if (field724.field2354 > 0) {
					var14 = class113.getPacketBufferNode(ClientPacket.field3213, packetWriter.isaacCipher);
					...
					for (var5 = 0; var5 < field724.field2354; ++var5) {
						...
						field638 = var19;
						var14.packetBuffer.method9314((int)var21);
						var14.packetBuffer.writeMediumLE(field724.field2353[var5]);
					}
				...
				if (field587 && field523 <= 0) {
					field523 = 20;
					field587 = false;
					var14 = class113.getPacketBufferNode(ClientPacket.field3216, packetWriter.isaacCipher);
				...
				if (class357.hasFocus && !hadFocus) {
					hadFocus = true;
					var14 = class113.getPacketBufferNode(ClientPacket.field3196, packetWriter.isaacCipher);
				...
				if (gameState == 30) {
						...
						if (queuedSoundEffectDelays[var1] >= -10) {
							...
							if (queuedSoundEffectDelays[var1] < 0) {
								if (soundLocations[var1] != 0) {
									...
									var3 = (var4 - var9) * WorldMapIcon_1.clientPreferences.method2605() / var4;
								} else {
									var3 = WorldMapIcon_1.clientPreferences.method2556();
								}
					...
					if (playingJingle && !BuddyRankComparator.method3006()) {
						if (WorldMapIcon_1.clientPreferences.method2554() != 0) {
							...
							if (var31) {
								class72.method2137(class514.archive6, WorldMapIcon_1.clientPreferences.method2554());
							}
						}
					...
					if (packetWriter.field1412 > 750) {
						...
						if (var32 && field724.method4316(82) && field724.method4316(81) && mouseWheelRotation != 0) {
							...
							if (var4 != class229.localPlayer.plane) {
								...
								var26.packetBuffer.writeByteNeg(var5);
								var26.packetBuffer.writeByteNeg(var6);
															...
															while (true) {
																...
																if (var48 == null) {
																	...
																	if (Scene.shouldSendWalk()) {
																		...
																		var26 = class113.getPacketBufferNode(ClientPacket.field3135, packetWriter.isaacCipher);
																		var26.packetBuffer.writeByte(5);
																		var26.packetBuffer.writeShort(NpcOverrides.baseX * 64 + var5);
																		var26.packetBuffer.writeShortAdd(class101.baseY * 64 + var6);
																		var26.packetBuffer.writeShortAddLE(field724.method4316(82) ? (field724.method4316(81) ? 2 : 1) : 0);
																		packetWriter.addNode(var26);
																		Scene.method5365();
																	...
																	if (var5 > 15000 && var6 > 15000) {
																		...
																		var26 = class113.getPacketBufferNode(ClientPacket.field3132, packetWriter.isaacCipher);
																		packetWriter.addNode(var26);
																	}
																	...
																	if (packetWriter.pendingWrites > 50) {
																		var26 = class113.getPacketBufferNode(ClientPacket.field3153, packetWriter.isaacCipher);
																		packetWriter.addNode(var26);
																	}
																			...
																			case 1:
																				if (ClanChannel.method3483(class361.getWidgetFlags(var48.field2349))) {
																					...
																					if (var43 != null) {
																						...
																						var26.packetBuffer.writeIntME(var43[1]);
																						var26.packetBuffer.writeInt(var43[0]);
																						var26.packetBuffer.writeShortLE(var48.field2349.childIndex);
																						var26.packetBuffer.writeInt(var43[2]);
																						var26.packetBuffer.writeIntME(var48.field2349.id);
																						var26.packetBuffer.writeIntLE(var48.field2349.method6689());
																						packetWriter.addNode(var26);
																					}
																				}
																			}
	...
	public void vmethod6202(int var1, int var2) {
		if (packetWriter != null && packetWriter.isaacCipher != null) {
			if (var1 > -1 && WorldMapIcon_1.clientPreferences.method2554() > 0 && !playingJingle) {
		...
		if (var2 == null) {
			...
			try {
				...
				if (ServerPacket.field3266 == var1.serverPacket) {
					...
					tradeChatMode = var3.readUnsignedShortAddLE();
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3312 == var1.serverPacket) {
					...
					PacketBufferNode var79 = class113.getPacketBufferNode(ClientPacket.field3128, packetWriter.isaacCipher);
					var79.packetBuffer.method9316(var21);
					var79.packetBuffer.writeIntLE(var5);
					var79.packetBuffer.writeMediumLE(var6);
				...
				if (ServerPacket.field3334 == var1.serverPacket) {
					class18.field85 = var3.readUnsignedByteNeg();
					class6.field14 = var3.readUnsignedByteSub();
				...
				if (ServerPacket.field3335 == var1.serverPacket) {
					class18.field85 = var3.readUnsignedShortAddLE();
					class6.field14 = var3.readUnsignedByteSub();
					var1.serverPacket = null;
					return true;
				}
				...
				if (ServerPacket.field3351 == var1.serverPacket) {
					...
					var16 = var3.readUnsignedByteAdd();
				...
				if (ServerPacket.field3326 == var1.serverPacket) {
					class18.field85 = var3.readUnsignedShortAddLE();
					class6.field14 = var3.readUnsignedShortAddLE();
			...
			if (MouseHandler.MouseHandler_currentButton == 0) {
				if (isDraggingWidget) {
					...
					if (draggedOnWidget != null && class227.method4434(clickedWidget) != null) {
						PacketBufferNode var9 = class113.getPacketBufferNode(ClientPacket.field3146, packetWriter.isaacCipher);
						var9.packetBuffer.writeShortAdd(clickedWidget.itemId);
						var9.packetBuffer.writeByteNeg(draggedOnWidget.childIndex);
						...
						var9.packetBuffer.writeByteNeg(draggedOnWidget.itemId);
